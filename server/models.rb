...
require_relative 'models/001_User'
require_relative 'models/002_Contact'
require_relative 'models/003_IncomeCategory'
require_relative 'models/004_Income'
require_relative 'models/005_ExpenseCategory'
require_relative 'models/006_Expense'